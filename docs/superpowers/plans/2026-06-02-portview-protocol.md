# PortviewProtocol Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Build `PortviewProtocol`, the pure-Swift wire-protocol package that both the Mac host and iPhone client depend on — binary codec primitives, the six-lane message set needed for M0, self-delimiting framing with stream reassembly, and the connection handshake state machines.
...
- Create: `Sources/PortviewProtocol/Portview.swift`
- Test: `Tests/PortviewProtocolTests/SmokeTests.swift`
...
```swift
// Sources/PortviewProtocol/Portview.swift
...
```swift
// Tests/PortviewProtocolTests/SmokeTests.swift
import Testing
...
git commit -m "feat(protocol): scaffold PortviewProtocol package"
```
...
**Files:**
- Create: `Sources/PortviewProtocol/WireError.swift`
- Create: `Sources/PortviewProtocol/BinaryWriter.swift`
- Create: `Sources/PortviewProtocol/BinaryReader.swift`
- Test: `Tests/PortviewProtocolTests/BinaryCodecTests.swift`

- [ ] **Step 1: Write the failing tests**

```swift
// Tests/PortviewProtocolTests/BinaryCodecTests.swift
import Testing
@testable import PortviewProtocol
...
```swift
// Sources/PortviewProtocol/WireError.swift
...
```swift
// Sources/PortviewProtocol/BinaryWriter.swift
...
```swift
// Sources/PortviewProtocol/BinaryReader.swift
...
**Files:**
- Create: `Sources/PortviewProtocol/Lane.swift`
- Create: `Sources/PortviewProtocol/Codec.swift`
- Create: `Sources/PortviewProtocol/ProtocolVersion.swift`
- Test: `Tests/PortviewProtocolTests/EnumTests.swift`

- [ ] **Step 1: Write the failing tests**

```swift
// Tests/PortviewProtocolTests/EnumTests.swift
import Testing
@testable import PortviewProtocol
...
```swift
// Sources/PortviewProtocol/Lane.swift
...
```swift
// Sources/PortviewProtocol/Codec.swift
...
```swift
// Sources/PortviewProtocol/ProtocolVersion.swift
...
**Files:**
- Create: `Sources/PortviewProtocol/MessageType.swift`
- Create: `Sources/PortviewProtocol/WireMessage.swift`
- Create: `Sources/PortviewProtocol/DisplayInfo.swift`
- Create: `Sources/PortviewProtocol/Messages/ClientHello.swift`
- Create: `Sources/PortviewProtocol/Messages/ServerHello.swift`
- Test: `Tests/PortviewProtocolTests/HelloMessageTests.swift`

- [ ] **Step 1: Write the failing tests**

```swift
// Tests/PortviewProtocolTests/HelloMessageTests.swift
import Testing
@testable import PortviewProtocol
...
```swift
// Sources/PortviewProtocol/MessageType.swift
...
```swift
// Sources/PortviewProtocol/WireMessage.swift
...
```swift
// Sources/PortviewProtocol/DisplayInfo.swift
...
```swift
// Sources/PortviewProtocol/Messages/ClientHello.swift
...
```swift
// Sources/PortviewProtocol/Messages/ServerHello.swift
...
**Files:**
- Create: `Sources/PortviewProtocol/Messages/StartSession.swift`
- Create: `Sources/PortviewProtocol/Messages/VideoFrame.swift`
- Create: `Sources/PortviewProtocol/Messages/Bye.swift`
- Create: `Sources/PortviewProtocol/Messages/ProtocolError.swift`
- Test: `Tests/PortviewProtocolTests/SessionMessageTests.swift`

- [ ] **Step 1: Write the failing tests**

```swift
// Tests/PortviewProtocolTests/SessionMessageTests.swift
import Testing
@testable import PortviewProtocol
...
```swift
// Sources/PortviewProtocol/Messages/StartSession.swift
...
```swift
// Sources/PortviewProtocol/Messages/VideoFrame.swift
...
```swift
// Sources/PortviewProtocol/Messages/Bye.swift
...
```swift
// Sources/PortviewProtocol/Messages/ProtocolError.swift
...
**Files:**
- Create: `Sources/PortviewProtocol/AnyMessage.swift`
- Create: `Sources/PortviewProtocol/Frame.swift`
- Test: `Tests/PortviewProtocolTests/FrameTests.swift`

- [ ] **Step 1: Write the failing tests**

```swift
// Tests/PortviewProtocolTests/FrameTests.swift
import Testing
@testable import PortviewProtocol
...
```swift
// Sources/PortviewProtocol/AnyMessage.swift
...
```swift
// Sources/PortviewProtocol/Frame.swift
...
**Files:**
- Create: `Sources/PortviewProtocol/FrameDecoder.swift`
- Test: `Tests/PortviewProtocolTests/FrameDecoderTests.swift`

- [ ] **Step 1: Write the failing tests**

```swift
// Tests/PortviewProtocolTests/FrameDecoderTests.swift
import Testing
@testable import PortviewProtocol
...
```swift
// Sources/PortviewProtocol/FrameDecoder.swift
...
**Files:**
- Create: `Sources/PortviewProtocol/HandshakeError.swift`
- Create: `Sources/PortviewProtocol/ClientHandshake.swift`
- Create: `Sources/PortviewProtocol/ServerHandshake.swift`
- Test: `Tests/PortviewProtocolTests/HandshakeTests.swift`

- [ ] **Step 1: Write the failing tests**

```swift
// Tests/PortviewProtocolTests/HandshakeTests.swift
import Testing
@testable import PortviewProtocol
...
```swift
// Sources/PortviewProtocol/HandshakeError.swift
...
```swift
// Sources/PortviewProtocol/ClientHandshake.swift
...
```swift
// Sources/PortviewProtocol/ServerHandshake.swift
...
**Files:**
- Test: `Tests/PortviewProtocolTests/EndToEndHandshakeTests.swift`
- Modify: `.docs/ai/current-state.md`

- [ ] **Step 1: Write the integration test**

```swift
// Tests/PortviewProtocolTests/EndToEndHandshakeTests.swift
import Testing
@testable import PortviewProtocol
...
- `PortviewProtocol` package: builds clean, `swift test` all green. Wire protocol (primitives, 6 messages, framing, FrameDecoder, handshake state machines) complete.
- Next: `PortviewTransport` (QUIC over Network.framework) — its own plan.
```

And in `.docs/ai/roadmap.md`, check off the first M0 item (`PortviewProtocol`).
