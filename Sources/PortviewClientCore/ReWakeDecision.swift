...
// `HostBeaconRecord` — the CK record codec this decision consumes — lives in `PortviewProtocol`
// (the schema both ends share; the host's beacon writer must not depend on the client core).
